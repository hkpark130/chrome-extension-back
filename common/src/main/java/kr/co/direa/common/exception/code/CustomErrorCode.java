...
//    NOT_FOUND_USER(404, "U001", "해당 유저가 없습니다."),
    ...
    NOT_FOUND_BOOKMARK(HttpStatus.NOT_FOUND, "B001", "해당 북마크가 없습니다."),

//    SCHEDULER_ERROR(500, "S001", "scheduler 에러"),
//    MAIL_SEND_ERROR(500, "S002", "메일 송신중 에러"),
    INTERNAL_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "D099", "서버 에러");

    private final HttpStatus status;
    private final String rspCode;
    private final String rspMsg;

    CustomErrorCode(HttpStatus status, final String rspCode, final String rspMsg) {
        this.status = status;
